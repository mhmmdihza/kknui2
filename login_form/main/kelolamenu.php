...
<body>
	...
	<br />
	<a href="add_kelola_menu_form.php">+ Tambah Data Baru</a>
	...
	<div style="overflow: auto;">
		<table border="1" class="table">
			...
			<?php 
			$make_call = callAPI('POST', 'http://localhost:8080/menu/findall', null);
			...
			?>
				<tr>
					<td><?php echo $response[$i]['namaMenu']; ?></td>
					<td width="90px" align="center">
						<a href="proses_hapus_kelolamenu.php?id=<?php echo $response[$i]['id']; ?>&menu=<?php echo$response[$i]['namaTabel']?>" onclick="return confirm('Yakin hapus menu?')">Hapus</a>						
					</td>
				</tr>
			<?php
			} ?>
